...
class HashTestCase(unittest.TestCase):
    ...
    def test_generate_hash(self):
        ...
        with unittest.mock.patch('auth_biohash.orthonormalization.TokenDataGenerator'):
            with unittest.mock.patch('auth_biohash.orthonormalization.TokenMatrixNormalization') as fake_normalizer:
                fake_normalizer.return_value.normalize.return_value = fake_data
    ...
    def test_additional_normalization(self):
        ...
        with unittest.mock.patch('auth_biohash.orthonormalization.TokenDataGenerator'):
            with unittest.mock.patch('auth_biohash.orthonormalization.TokenMatrixNormalization') as fake_normalizer:
                fake_normalizer.return_value.normalize.return_value = np.zeros((4,))
